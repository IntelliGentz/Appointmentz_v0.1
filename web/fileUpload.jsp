        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>APPointmentZ</strong> Upload Patients</h1>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top">
                        <div class="form-top-left">
                            <h3>Use this form to upload patient list</h3>
                            <p>Upload the information of patients to the system:</p>
                        </div>
                    ...
                    <div class="form-bottom">
                        <form role="form" action="upload" method="post" class="login-form" enctype="multipart/form-data">
